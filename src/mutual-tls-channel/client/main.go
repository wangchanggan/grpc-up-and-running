...
import (
	...
	"path/filepath"
	"time"
	pb "mutual-tls-channel/client/ecommerce"
...
var (
	...
	hostname = "localhost"
	crtFile = filepath.Join("src", "mutual-tls-channel", "certs", "client.crt")
	keyFile = filepath.Join("src", "mutual-tls-channel", "certs", "client.key")
...
func main() {
	...
	opts := []grpc.DialOption{
		...
		// 添加传输凭证作为连接选项。ServerName必须与证书中的Common Name一致。
