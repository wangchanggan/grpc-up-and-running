...
import (
	...
	pb "grpc-opencensus-tracing/proto"
	"google.golang.org/grpc"
	// 导入OpenTracing和Jaeger库。
...
func main() {
	// 调用initTracing函数，初始化Jaeger导出器实例，并使用trace进行注册。
    initTracing()
	...
	for {
		...
		// 通过传递ProductID来调用GetProduct远程方法。
