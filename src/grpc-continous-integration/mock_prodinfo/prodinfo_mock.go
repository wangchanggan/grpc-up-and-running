...
// Source: grpc-continous-integration/proto_gen (interfaces: ProductInfoClient)
...
import (
	context "context"
	proto_gen "grpc-continous-integration/proto_gen"
	reflect "reflect"
...
func (m *MockProductInfoClient) AddProduct(arg0 context.Context, arg1 *proto_gen.Product, arg2 ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductInfoClient) GetProduct(arg0 context.Context, arg1 *wrapperspb.StringValue, arg2 ...grpc.CallOption) (*proto_gen.Product, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
