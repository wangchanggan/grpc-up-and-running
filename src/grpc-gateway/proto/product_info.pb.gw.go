...
func RegisterProductInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductInfoServer) error {
	...
	mux.Handle("POST", pattern_ProductInfo_AddProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.ProductInfo/AddProduct", runtime.WithHTTPPathPattern("/v1/product"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ProductInfo_GetProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.ProductInfo/GetProduct", runtime.WithHTTPPathPattern("/v1/product/{value}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterProductInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProductInfoClient) error {
	...
	mux.Handle("POST", pattern_ProductInfo_AddProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.ProductInfo/AddProduct", runtime.WithHTTPPathPattern("/v1/product"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ProductInfo_GetProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.ProductInfo/GetProduct", runtime.WithHTTPPathPattern("/v1/product/{value}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
